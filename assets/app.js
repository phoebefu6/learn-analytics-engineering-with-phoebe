...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-analytics-engineering.html",
           "a2-models-as-code.html",
           "a3-tests-as-trust.html",
           "a4-buy-vs-build.html",
           "a5-team-shape.html",
           "a6-docs-that-stay-true.html"]
        : ["b1-hand-written-to-project.html",
           "b2-project-config.html",
           "b3-sources-and-staging.html",
           "b4-ref-and-the-dag.html",
           "b5-intermediate-models.html",
           "b6-dimensions-facts-snapshots.html",
           "b7-break-a-model.html",
           "b8-marts-and-questions.html",
           "b9-contracts-docs-ci.html",
           "b10-capstone.html"];
